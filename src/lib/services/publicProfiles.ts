...
export async function getPublicProfileData(userId: string): Promise<PublicProfileData> {
  ...
  const visitedHotspots = (hotspotsRes.data || []).map((h: any) => {
    ...
    const firstImage = rawImages[0] || "/images/placeholder-image.png";
    return {
    ...
    { 
      ...
      name: 'Secret Castle', 
      province: 'Vlaanderen', 
      images: ["/images/placeholder-image.png"],image_url: '/images/placeholder-image.png',visited_at: '2024-03-20',latitude: 50.85,
      longitude: 4.35,
      category: 'castle'
    },
    { 
      ...
      name: 'Forest Lake', 
      province: 'Wallonie', 
      images: ["/images/placeholder-image.png"],      image_url: '/images/placeholder-image.png',      visited_at: '2024-03-18',      latitude: 50.5,
      longitude: 4.0,
      category: 'nature'
    }
  ];
