    ...
    <section className="py-8 bg-slate-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl">
          ...
          <div className="group relative p-6 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl border border-emerald-100 hover:shadow-2xl transition-all duration-500 hover-lift">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Wishlist */}
          <div className="group relative p-6 bg-gradient-to-br from-rose-50 to-pink-50 rounded-3xl border border-rose-100 hover:shadow-2xl transition-all duration-500 hover-lift">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Streak */}
          <div className="group relative p-6 bg-gradient-to-br from-orange-50 to-amber-50 rounded-3xl border border-orange-100 hover:shadow-2xl transition-all duration-500 hover-lift">
            <div className="flex items-center gap-3 mb-4">
