  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="flex-1 flex min-w-0 flex-col overflow-hidden">
        <header className="sticky top-2 z-50 mx-4 md:mx-6 rounded-xl backdrop-blur-lg bg-white/70 shadow-xl border border-slate-200 transition-all duration-300 flex items-center justify-between px-4 py-3 md:py-4">
